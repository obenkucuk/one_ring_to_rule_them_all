...
import '../pages/main_pages/page_a/page_a_page.dart' as _i3;
import '../pages/main_pages/page_b/pages_b_page.dart' as _i4;
...
class AppRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    ...
    RouteA.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i3.PageAPage(),
      );
    },
    RouteB.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i4.PageBPage(),
      );
    },
  };
